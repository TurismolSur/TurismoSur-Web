...
export function VehicleGrid({ startDate, endDate }: VehicleGridProps) {
  ...
  const handleResetFilters = () => {
    setFilters({
      ...
      min_seats: '',
      max_seats: '',
      min_price: filterOptions?.priceRange.min.toString() || '',
      max_price: filterOptions?.priceRange.max.toString() || '',
      transmission: '',
      fuel_type: '',
    });
  };
  ...
  const handleSelectVehicle = (vehicleId: string) => {
    // TODO: Navegar a página de confirmación de reserva
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow p-6 sticky top-8">
              ...
              <div className="mb-6">
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  Precio Diario (${filters.min_price} - ${filters.max_price})
                </label>
                <div className="flex gap-2">
                  <input
                    type="number"
